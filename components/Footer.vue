<template>
  <!-- FOOTER -->
  <footer
    class="bg-[#0b0e37] text-white py-4 px-4 font-sans tracking-wide p-4 mt-auto"
  >
    <div class="text-center">
      <h6 class="text-base">Stay connected with us:</h6>

      <ul class="flex flex-wrap justify-center gap-4 my-8 gap-x-8">
        <li>
      ...
      <p class="text-base">© TaiwoDev. All rights reserved.</p>
    </div>
  </footer>
</template>
